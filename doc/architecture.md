...
- [Architecture Overview](#architecture-overview)
  ...
  - [Architecture](#architecture)
    - [OpenNESS Kubernetes Control Plan](#openness-kubernetes-control-plane)
...
The OpenNESS Kubernetes Control Plane consists of Vanilla Kubernetes Control Plane components along with OpenNESS microservices that interact with the Kubernetes Control Plane Node using Kubernetes defined APIs. 
