...
```
<!-- omit in toc -->
# Using ACC100 eASIC in Smart Edge Open: Resource Allocation, and Configuration
- [Overview](#overview)
...
- [Using the Intel vRAN Dedicated Accelerator ACC100 on Smart Edge Open](#using-the-intel-vran-dedicated-accelerator-acc100-on-smartedge-open)
  - [ACC100 (FEC) Ansible Installation for Smart Edge Open Network Edge](#acc100-fec-ansible-installation-for-smartedge-open-network-edge)
    - [Converged Edge Experience Kits](#converged-edge-experience-kits)
  - [FEC VF configuration for Smart Edge Open Network Edge](#fec-vf-configuration-for-smartedge-open-network-edge)
  - [Requesting Resources and Running Pods for Smart Edge Open Network Edge](#requesting-resources-and-running-pods-for-smartedge-open-network-edge)
  - [Verifying Application POD Access and Usage of FPGA on Smart Edge Open Network Edge](#verifying-application-pod-access-and-usage-of-fpga-on-smartedge-open-network-edge)
- [Reference](#reference)
...
![Intel® vRAN Dedicated Accelerator ACC100 Orchestration and deployment with Smart Edge Open Network Edge for FlexRAN](acc100-images/acc100-k8s.png)

_Figure - Intel® vRAN Dedicated Accelerator ACC100 Orchestration and deployment with Smart Edge Open Network Edge for FlexRAN_

## Using the Intel vRAN Dedicated Accelerator ACC100 on Smart Edge Open
Further sections provide instructions on how to use the ACC100 eASIC features: configuration and accessing from an application on the Smart Edge Open Network Edge.
...
### ACC100 (FEC) Ansible Installation for Smart Edge Open Network Edge
To run the Smart Edge Open package with ACC100 (FEC) functionality, the feature needs to be enabled on both Edge Controller and Edge Node. It can be deployed via the ["flexran" flavor of Smart Edge Open](https://github.com/smart-edge-open/ido-converged-edge-experience-kits/tree/master/flavors/flexran).

#### Converged Edge Experience Kits
To enable ACC100 support from CEEK, SRIOV must be enabled in Smart Edge Open:
```yaml
...
As part of the Smart Edge Open Ansible automation, a K8s SRIOV device plugin to orchestrate the ACC100 VFs (bound to the userspace driver) is running. This enables the scheduling of pods requesting this device. To check the number of devices available on the Edge Node from Edge Controller, run:
