...
```
<!-- omit in toc -->
# Using FPGA in Smart Edge Open: Programming, Resource Allocation, and Configuration
- [Overview](#overview)
...
- [Intel(R) FPGA PAC N3000 remote system update flow in Smart Edge Open Network edge Kubernetes](#intelr-fpga-pac-n3000-remote-system-update-flow-in-smart-edge-open-network-edge-kubernetes)
- [Using an FPGA on Smart Edge Open](#using-an-fpga-on-smart-edge-open)
  - [FPGA (FEC) Ansible installation for Smart Edge Open Network Edge](#fpga-fec-ansible-installation-for-smart-edge-open-network-edge)
    - [Converged Edge Experience Kits](#converged-edge-experience-kits)
  - [FPGA programming and telemetry on Smart Edge Open Network Edge](#fpga-programming-and-telemetry-on-smart-edge-open-network-edge)
    - [Telemetry monitoring](#telemetry-monitoring)
  - [FEC VF configuration for Smart Edge Open Network Edge](#fec-vf-configuration-for-smart-edge-open-network-edge)
  ...
  - [Verifying Application POD access and usage of FPGA on Smart Edge Open Network Edge](#verifying-application-pod-access-and-usage-of-fpga-on-smart-edge-open-network-edge)
- [Reference](#reference)
...
![PAC N3000 Host interface overview](fpga-images/smartedge-open-fpga1.png)
...
![Intel PAC N3000 Orchestration and deployment with Smart Edge Open Network Edge for FlexRAN](fpga-images/smartedge-open-fpga2.png)

_Figure - Intel PAC N3000 Orchestration and deployment with Smart Edge Open Network Edge for FlexRAN_

## Intel(R) FPGA PAC N3000 remote system update flow in Smart Edge Open Network edge Kubernetes
...
![Smart Edge Open Network Edge Intel PAC N3000 RSU and resource allocation](fpga-images/smartedge-open-fpga3.png)

_Figure - Smart Edge Open Network Edge Intel® FPGA PAC N3000 RSU and resource allocation_

## Using an FPGA on Smart Edge Open
Further sections provide instructions on how to use all three FPGA features: programming, configuration, and accessing from an application on the Smart Edge Open Network Edge.
...
### FPGA (FEC) Ansible installation for Smart Edge Open Network Edge
...
### FPGA programming and telemetry on Smart Edge Open Network Edge
...
#### Telemetry monitoring
  ...
  Support for monitoring temperature and power telemetry of the Intel® FPGA PAC N3000 is also provided from Smart Edge Open with a CollectD collector that is configured for the `flexran` flavor. Intel® FPGA PAC N3000 telemetry monitoring is provided to CollectD as a plugin. It collects the temperature and power metrics from the card and exposes them to Prometheus\* from which the user can easily access the metrics. For more information on how to enable telemetry for FPGA in Smart Edge Open, see the [telemetry whitepaper](../../building-blocks/enhanced-platform-awareness/smartedge-open-telemetry.md#collectd).

  ![PACN3000 telemetry](fpga-images/smartedge-open-fpga4.png)

### FEC VF configuration for Smart Edge Open Network Edge
...
**NOTE**: The name of the resource must match the name specified in the configMap for the K8s devices plugin [configMap.yml](https://github.com/smart-edge-open/converged-edge-experience-kits/blob/master/roles/kubernetes/cni/sriov/controlplane/templates/configMap.yml.j2).
...
### Verifying Application POD access and usage of FPGA on Smart Edge Open Network Edge
