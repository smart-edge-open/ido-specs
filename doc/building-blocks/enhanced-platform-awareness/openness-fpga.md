...
To enable FPGA support from OEK, change the variable `ne_opae_fpga_enable` in `inventory/default/group_vars/all/10-open.yml` (or flavor alternative file) to `true`:
```yaml
