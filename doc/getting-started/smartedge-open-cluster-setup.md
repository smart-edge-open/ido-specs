...
3. Clone [Converged Edge Experience Kits](https://github.com/smart-edge-open/converged-edge-experience-kits)
...
Support for VM deployment on Smart Edge Open for Network Edge is available and enabled by default. Certain configurations and prerequisites may need to be satisfied to use all VM capabilities. The user is advised to become familiar with the VM support documentation before executing the deployment playbooks. See [smartedge-open-network-edge-vm-support](../../applications-onboard/smartedge-open-network-edge-vm-support.md) for more information.

### Application on-boarding

Refer to the [network-edge-applications-onboarding](../../applications-onboard/network-edge-applications-onboarding.md) document for instructions on how to deploy edge applications for Smart Edge Open Network Edge.
...
* [weavenet](https://github.com/weaveworks/weave)
  * CIDR: 10.32.0.0/12
* [SR-IOV](https://github.com/intel/sriov-cni) (cannot be used as a standalone or primary CNI - [sriov setup](../../building-blocks/enhanced-platform-awareness/smartedge-open-sriov-multiple-interfaces.md))
* [Userspace](https://github.com/intel/userspace-cni-network-plugin) (cannot be used as a standalone or primary CNI - [Userspace CNI setup](../../building-blocks/dataplane/smartedge-open-userspace-cni.md)
...
The default CNI for Smart Edge Open is calico. Non-default CNIs may be configured with Smart Edge Open by editing the file `inventory/default/group_vars/all/10-open.yml`.
...
- `all` contains all the variable definitions relevant to the cluster:
  > `cluster_name`: defines the name of the Smart Edge Open edge cluster 
  > `flavor`: the deployment flavor to be deployed to the Smart Edge Open edge cluster
...
[The non-root user on the Smart Edge Open Platform](../../building-blocks/enhanced-platform-awareness/smartedge-open-nonroot.md)
## Setting proxy
