...
1. Deploy the OpenNESS cluster with [SRIOV for FPGA enabled](../../building-blocks/enhanced-platform-awareness/openness-fpga.md#fpga-fec-ansible-installation-for-openness-network-edge).
